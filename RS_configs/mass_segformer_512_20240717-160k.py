...
data_root = '/HDD01/ /data/Massachusetts/png/'
...
model = dict(
    backbone=dict(
        ...
        init_cfg=dict(
            checkpoint=
            '/data1/ /code/mmsegmentation/mmsegmentation/work_dirs/new-dice-whu-v2-SSIM-detach-add-img_aug2_ave_auxiliary-160k/best_mIoU_iter_81500_bk.pth',
            type='Pretrained'),
        mlp_ratio=4,
        num_heads=[
            1,
...
test_dataloader = dict(
    ...
    dataset=dict(
        data_prefix=dict(
            img_path='test_split',
            img_path2='test_split_aug',
            seg_map_path='test_labels_split'),
        data_root='/HDD01/ /data/Massachusetts/png/',
        pipeline=[
...
train_dataloader = dict(
    ...
    dataset=dict(
        data_prefix=dict(
            img_path='train_split',
            img_path2='train_split_aug',
            seg_map_path='train_labels_split'),
        data_root='/HDD01/ /data/Massachusetts/png/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadImageOtherFromFile'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        data_prefix=dict(
            # img_path='val_split',
            # img_path2='val_split_aug',
            # seg_map_path='val_labels_split'),
        # data_root='/HDD01/ /data/Massachusetts/png/',
            img_path='test_split',
            img_path2='test_split_aug',
            seg_map_path='test_labels_split'),
...
work_dir = './work_dirs/new-mass-v4-auxiliary_weight-SSIM-img-160k'
