...
data_root = '/HDD01/ /data/airs-archive/'
dataset_type = 'ChristchurchDataset'
default_hooks = dict(
    checkpoint=dict(
        by_epoch=False,
        interval=1000,
...
work_dir = './work_dirs/Christchurch-v1-SSIM-detach-add-img_aug2_ave-160k'
