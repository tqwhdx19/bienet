...
load_from = '/data1/ /code/mmsegmentation/mmsegmentation/work_dirs/whu-v7-SSIM-detach-add-img-160k/iter_118000.pth'
log_level = 'INFO'
...
work_dir = './work_dirs/mass-v5-SSIM-img_load_weights-160k'
