...
from .rec_loss import L1StylePerceptualLoss
from .weighted_l2_loss import L2WeightedLoss
...
__all__ = [
    ...
    'HuasdorffDisstanceLoss', 'SiLogLoss', 'L1SsimLoss', 'L1StylePerceptualLoss',
    'L2WeightedLoss',
]
