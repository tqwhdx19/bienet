...
@TRANSFORMS.register_module()
class RandomCropWithAug(RandomCrop):
    """Random crop the image & seg.
    ...
    def __init__(self, **resize_kwargs):
        super(RandomCropWithAug, self).__init__(**resize_kwargs)
    ...
    def transform(self, results: dict) -> dict:
        ...
        img_aug = self.crop(img_aug, crop_bbox)
...
@TRANSFORMS.register_module()
class RandomFlipWithAug(RandomFlip):
    def __init__(self, **resize_kwargs):
        super(RandomFlipWithAug, self).__init__(**resize_kwargs)
    ...
    def _flip(self, results: dict) -> None:
        ...
        # flip aug image
        results['img_aug'] = mmcv.imflip(
            results['img_aug'], direction=results['flip_direction'])
