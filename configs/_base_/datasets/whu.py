...
train_pipeline = [
    ...
    dict(
        ...
        ratio_range=(0.5, 2.0),
        keep_ratio=True),
    dict(type='RandomCropWithAug', crop_size=crop_size, cat_max_ratio=0.75),
    dict(type='RandomFlipWithAug', prob=0.5),
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(
            ...
            img_path2='WHU_aug/img_dir/train',
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(
            ...
            img_path2='WHU_aug/img_dir/test',
